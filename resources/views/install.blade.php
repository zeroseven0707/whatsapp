                        ...
                        <div class="content body">
                            ...
                            <div class="step general" :class="{ active: stepIsActive(2) }">
                                <div class="field">
                                    ...
                                    <input id="licensekey" type="text" name="licensekey" value="">
                                </div>

                                <div class="field">
                                    <label>{{ __('Buyer Email') }}</label>
                                    <input id="buyeremail" type="email" name="buyeremail" value="">
                                </div>

                                <div class="field">
                                    <button class="ui basic big fluid button rounded mx-0" type="button"
                                        @click="validateLicense($event)">Just Skip. click next!</button>
                                </div>
